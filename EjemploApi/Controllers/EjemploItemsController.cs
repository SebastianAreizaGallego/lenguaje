...
namespace EjemploApi.Controllers
{
    ...
    public class EjemploItemsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<EjemploItem>>> GetTodoItems()
        {
        ...
        {
            var ejemploItem = await _context.TodoItems.FindAsync(id);
        ...
        {
            _context.TodoItems.Add(ejemploItem);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<EjemploItem>> DeleteEjemploItem(long id)
        {
            ...
            _context.TodoItems.Remove(ejemploItem);
            await _context.SaveChangesAsync();
